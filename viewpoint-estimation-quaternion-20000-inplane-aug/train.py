...
import time
import pandas as pd
from utils import euler_to_quaternion, quaternion_cross_entropy
...
# Load dataset
data_dir = "/scratch/hnkmah001/Datasets/ctfullbody/quaternions_20000_classes/train-val/"
...
data_aug = tf.keras.Sequential([tf.keras.layers.experimental.preprocessing.RandomRotation(factor=(-0.125, 0.125), fill_mode='constant', 
            interpolation='bilinear', seed=123, name=None)], name="data_augmentation_layer")
x = data_aug(inputs)
x = baseModel(x)
...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-quaternions-20000-inplane-aug/checkpoints/"
...
train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-quaternions-20000-inplane-aug/logs/train"
val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-quaternions-20000-inplane-aug/logs/val"
