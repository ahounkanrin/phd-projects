...
# Load dataset
data_dir = "/scratch/hnkmah001/Datasets/ctfullbody/roll-pitch-yaw-regular/train-val/"
train_df = pd.read_csv("train.csv", sep=",")
img_path = train_df["image"].apply(lambda imgID: data_dir+imgID)
label_roll = train_df["azimuth"].astype(float)
label_pitch = train_df["elevation"].astype(float)
label_yaw = train_df["inplane"].astype(float)
...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-roll-pitch-yaw-regular/checkpoints/"
...
train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-roll-pitch-yaw-regular/logs/train"
val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-roll-pitch-yaw-regular/logs/val"
...
for epoch in range(args.epochs):
    ...
    template = "Epoch {}, Validation Loss: {:.6f},ckpt {}\n\n"
