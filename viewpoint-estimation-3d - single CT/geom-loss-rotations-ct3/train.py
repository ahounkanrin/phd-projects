...
# Load ct volume
INPUT_SIZE = (200, 200)
imgpath1 = "/scratch/hnkmah001/Datasets/ctfullbody/train-data/SMIR.Body.058Y.M.CT.59468/SMIR.Body.058Y.M.CT.59468.nii"
N = 512 
...
for epoch in range(args.epochs):
    ...
    while len(xtrain_epoch) > 0:
        ...
        if step == 0:
            train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/geom-loss-out-of-plane-rotation-ct3/logs/train"
            val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/geom-loss-out-of-plane-rotation-ct3/logs/val"
