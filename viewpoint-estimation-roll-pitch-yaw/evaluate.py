...
# Load dataset
data_dir = "/scratch/hnkmah001/Datasets/ctfullbody/roll_pitch_yaw/test/"
test_df = pd.read_csv("test.csv", sep=",")
img_path = test_df["image"].apply(lambda imgID: data_dir+imgID)
label_roll = (np.pi/180) * test_df["azimuth"].astype(int)
label_pitch = (np.pi/180) * test_df["elevation"].astype(int)
label_yaw = (np.pi/180) * test_df["inplane"].astype(int)
...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-roll-pitch-yaw/checkpoints/"
