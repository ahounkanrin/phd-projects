...
lr_schedule = tf.keras.optimizers.schedules.ExponentialDecay(args.learning_rate, decay_steps=500, decay_rate=0.96, staircase=True)
...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation2/geom-loss-no-aug/checkpoints/"
...
train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation2/geom-loss-no-aug/logs/train"
val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation2/geom-loss-no-aug/logs/val"
...
for epoch in range(args.epochs):
    for images, labels in train_data:
        ...
        with train_summary_writer.as_default():
            ...
            #tf.summary.image("image", images.values[0], step=step, max_outputs=2) # sample 2 images/batch from Replica 0
        toc = time.time()
