...
inputs = tf.keras.Input(shape=(900,)) # (4356,) | (20736,)
...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/hog/checkpoints/"
...
for epoch in range(args.epochs):
    ...
    while len(xtrain_epoch) > 0:
        ...
        if step == 0:
            train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/hog/logs/train"
            val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/hog/logs/val"
