...
def render_test_view(viewpoint):
    ...
    hogFeature = hog(img, orientations=9, pixels_per_cell=(8, 8),
...
# Define the model
inputs = tf.keras.Input(shape=(20736,)) # | (20736,)  | (900,) | (4356,) | (144,)
...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/hog8x8/checkpoints/"
