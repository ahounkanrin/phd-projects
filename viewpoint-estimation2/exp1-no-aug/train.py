...
with strategy.scope():
    ...
    train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation2/geom-loss/logs/train"
    val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation2/geom-loss/logs/val"
