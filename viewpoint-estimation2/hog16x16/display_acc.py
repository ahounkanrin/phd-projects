...
imgs = [cv.imread("accuracy_{}_hog.png".format(id))[..., ::-1] for id in testID]
fig, ax = plt.subplots(nrows=2, ncols=3, figsize=(30, 12)) #
fig.suptitle("Accuracy of viewpoint estimation for different CT-scans (HOG network)", fontsize=20)
