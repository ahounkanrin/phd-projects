...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation/classification/cnn/one_hot_labels_geom_loss-in-plane-rotation/checkpoints/"
...
if args.is_training:
    ...
    train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation/classification/cnn/one_hot_labels_geom_loss-in-plane-rotation/logs/train"
    val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation/classification/cnn/one_hot_labels_geom_loss-in-plane-rotation/logs/val"
    ...
    for epoch in tqdm(range(args.epochs)): 
        x_train = np.array(list(map(random_rotate_image, xtrain)))
        x_val = np.array(xval)
    ...
    #checkpoint.restore("/scratch/hnkmah001/phd-projects/viewpoint-estimation/classification/cnn/soft_labels2/checkpoints_100x100/ckpt-100") 
