...
baseModel = tf.keras.applications.DenseNet121(input_shape=(INPUT_SIZE[0], INPUT_SIZE[1], 3), 
                                              include_top=False, weights="imagenet")
...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/densenet121/checkpoints/"
...
for epoch in range(args.epochs):
    ...
    while len(xtrain_epoch) > 0:
        ...
        if step == 0:
            train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/densenet121/logs/train"
            val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/densenet121/logs/val"
