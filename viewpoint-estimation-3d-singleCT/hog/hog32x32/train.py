...
def render_train_view(viewpoint):
    ...
    hogFeature = hog(img, orientations=9, pixels_per_cell=(32, 32),
...
inputs = tf.keras.Input(shape=(900,)) # | (20736,)  |(4356,)
...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/hog_aug_rot/checkpoints/"
...
for epoch in range(args.epochs):
    ...
    while len(xtrain_epoch) > 0:
        ...
        if step == 0:
            train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/hog_aug_rot/logs/train"
            val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/hog_aug_rot/logs/val"
