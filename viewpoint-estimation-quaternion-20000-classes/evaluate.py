...
gt_quaternions = tf.squeeze(tf.stack([qw, qx, qy, qz], axis=-1))
...
test_data = tf.data.Dataset.from_tensor_slices((img_path_list, gt_quaternions)).batch(1)
