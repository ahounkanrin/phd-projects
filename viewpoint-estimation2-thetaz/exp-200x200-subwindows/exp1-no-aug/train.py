...
def crop_image(img):
    ...
    img = tf.image.crop_to_bounding_box(img, offset_height=156+ty, offset_width=156+tx, target_height=200, target_width=200)
...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation2/exp-200x200-subwindowns/exp1-no-aug/checkpoints/"
...
train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation2/exp-200x200-subwindowns/exp1-no-aug/logs/train"
val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation2/exp-200x200-subwindowns/exp1-no-aug/logs/val"
