...
#err_list = []
#pred_list = []
for view_id in range(0, 360):d
	err_list = []
	for scale in scales:
		img_test = cv.imread("/scratch/hnkmah001/Datasets/ctfullbody/ctfullbody2d/SMIR.Body.040Y.M.CT.57768/s{}/{}.png".format(scale, view_id), 0)
