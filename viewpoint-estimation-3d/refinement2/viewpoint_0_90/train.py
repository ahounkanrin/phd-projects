...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/refinement2/viewpoint0_90/checkpoints/"
...
for epoch in range(args.epochs):
    ...
    while len(xtrain_epoch) > 0:
        ...
        if step == 0:
            train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/refinement2/viewpoint0_90/logs/train"
            val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/refinement2/viewpoint0_90/logs/val"
