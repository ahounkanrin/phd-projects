...
x1 = [(theta, tx, 0) for theta in range(20) for tx in range(-20, 21)]
x2 = [(theta, 0, ty) for theta in range(20) for ty in range(-20, 21) if ty!=0]
xtrainval = x1 + x2 
...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/geom-loss-20/checkpoints/"
...
for epoch in range(args.epochs):
    ...
    while len(xtrain_epoch) > 0:
        ...
        if step == 0:
            train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/geom-loss-20/logs/train"
            val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-3d/geom-loss-20/logs/val"
