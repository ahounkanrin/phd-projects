...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/CBIR/Imageclef/cnn/{}/checkpoints/".format(args.cnn)
...
train_logdir = "/scratch/hnkmah001/phd-projects/CBIR/Imageclef/cnn/{}/logs/train".format(args.cnn)
val_logdir = "/scratch/hnkmah001/phd-projects/CBIR/Imageclef/cnn/{}/logs/val".format(args.cnn)
