...
import time
import pandas as pd 
from utils import irma_cross_entropy
import h5py
import cv2 as cv
...
def train_step(images, labels):
    ...
    with tf.GradientTape() as tape:
        ...
        loss = irma_cross_entropy(predictions, labels)
...
def test_step(images, labels):
    ...
    test_loss = irma_cross_entropy(predictions, labels)
...
train_logdir = "/scratch/hnkmah001/phd-projects/CBIR/Imageclef/cnn-irma_crossentropy/{}/logs/train".format(args.cnn)
val_logdir = "/scratch/hnkmah001/phd-projects/CBIR/Imageclef/cnn-irma_crossentropy/{}/logs/val".format(args.cnn)
