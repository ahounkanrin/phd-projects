...
# Load dataset
data_dir = "/scratch/hnkmah001/Datasets/ctfullbody/quaternions_20000_classes/test/"
...
test_data = tf.data.Dataset.from_tensor_slices((img_path_list, labels_list)).batch(1).shuffle(160000)
...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/quaternions_20000_reg1/checkpoints/"
...
with open("result_train1_test1.txt", "w") as f:
...
for theta in thresholds:
    ...
    with open("result_train1_test1.txt", "a") as f:
